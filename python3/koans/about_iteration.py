...
class AboutIteration(Koan):
    ...
    def test_reduce_will_blow_your_mind(self):
        ...
        """        
        reduce takes aFunction and aSequence and applies the function
        left to right across a provided sequence reducing it to one
        value. Read more at: https://docs.python.org/3/library/functools.html
        """
